    ...
    <section>
      <div class ="login">
        ...
        <form id="form-login">
            ...
            <input type="text" size="50" id="setor" placeholder="Setor"><br><br>
            <input type="text" size="50" id="email" placeholder="E-mail"><br><br>
            <input type="password" size="50" id="senha" placeholder="senha"><br><br>
            <input type="password" size="50" id="cnpj" placeholder="CNPJ"><br><br>
            <input type="password" size="50" id="endereco" placeholder="Endereço"><br><br>
